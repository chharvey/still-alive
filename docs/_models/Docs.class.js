...
module.exports = (function () {
   ...
   */
  Docs.DOCS = (function () {
    return new Page({ name: 'Chris Harvey – Site Design', url: '/docs/' })
      ...
      .add(new Page({ name: 'Site Schemes', url: 'visual.html' })
        .add(new Page({ name: 'Typeface Scheme' , url: 'visual.html#typeface-scheme' }))
        .add(new Page({ name: 'Color Scheme'    , url: 'visual.html#color-scheme' }))
      )
